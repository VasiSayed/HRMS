...
class User(AbstractUser):
    ...
    Team_leader=models.ForeignKey('self',on_delete=models.SET_NULL,null=True,blank=True,related_name="Team_Leader")
    ...
    def __str__(self):
        return f"{self.role} : {self.username} Departmnt : {self.department.dept_name}"